        ...
        <div className="container" id="container-portfolio">
            <div className="row">
                ...
                <div className="col-md-6">
                    ...
                    <p id="p-portfolio">Email: <a href="mailto:ztayut2tx@gmail.com" id="email">ztayut2tx@gmail.com</a> or reach me by phone at: <a href="tel:+1-801-648-8668" id="phone">801-648-8668</a>.</p>
                    <div className="icons">
