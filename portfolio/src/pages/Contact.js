        ...
        <div className="container" id="container-portfolio">
            <div className="row">
                ...
                <div className="col-md-6">
                    <h1 id="h1-contact">Contact Info</h1>
                    <p id="p-portfolio" style={{color: "white"}}>Email: <a href="mailto:ztayut2tx@gmail.com" id="email">ztayut2tx@gmail.com</a> </p>
                    <p style={{color: "white"}}>Phone: <a href="tel:+1-801-648-8668" id="phone">801-648-8668</a></p>
                    <div className="icons">
